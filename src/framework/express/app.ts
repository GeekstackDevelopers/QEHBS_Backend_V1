...
import { adminApiPath, parentApiPath, studentApiPath, superAdminPath } from "../../shared/constant/constant";
...
import studentRouter from "../../interface/route/student";
const createApp = () => {
  ...
  app.use(studentApiPath.base, studentRouter);
